$(function () { // fake logics
	...
	var $chosenValuePresentor = $('#fund-jinshibao-trading-buy-in-confirm-choose-bank-card');
	$('.popup-panel-body .menu-item').on('click', function () {
		$chosenValuePresentor.html(this.innerHTML);
		UI.popupLayersManager.hide(pl2);
	});

	$('#fund-jinshibao-trading-buy-in-confirm-choose-bank-card').on('click', function(event) {
